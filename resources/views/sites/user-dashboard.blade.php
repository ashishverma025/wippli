                ...
                <div class="tabs">
                    <form>
                        <ul class="nav nav-tabs third-tab">
                            ...
                            @else
                            <li><a data-toggle="tab" onclick="return confirm('You don\'t have permission to add wippli please contact to Super Admin')" >New Wippli</a></li>
                            @endif
                                                            ...
                                                            <div class="row previewToday" data-id="{{$pwippli->id}}">
                                                                <div class="col-lg-3">
                                                                    <div class="small_company_logo">
                                                                        <?php
                                                                        $uId = $pwippli->userId;
                                                                        $wippliImage = !empty($pwippli->attachment) ? "public/sites/images/wippli-image/$uId/$pwippli->attachment" : 'public/wippli/img/logo-icn.png';
                                                                        ?>
                                                                        <img src="{{url($wippliImage)}}" alt="icn" height="50" width="50">
                                                                    </div>
                                                                </div>
