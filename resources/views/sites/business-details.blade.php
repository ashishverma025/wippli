               ...
               <div class="form_inner">
                        ...
                        <div class="row">
                           <div class="col-lg-6">
                              <div class="form-group">
                                 ...
                                 <input type="email" class="form-control" name="email"  placeholder="{contactemail}">
                              </div>
                           </div>
                           <div class="col-lg-6">
                              <div class="form-group">
                ...
                <div class="row">
                  <div class="col-lg-6">
                     <div class="form-group">
                        <label>Country <span>*</span></label>
                        <input class="form-control" type="text" name="country" id="country" placeholder="{businesscountry}">
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="form-group">
                        <label>State <span>*</span></label>
                        <input class="form-control" type="text" name="state" id="state" placeholder="{businessstate}">
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-lg-6">
                     <div class="form-group">
                        <label>Address line 1 <span>*</span></label>
                        <input class="form-control" type="text" name="address1" id="address1" placeholder="{businessaddress1}">
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="form-group">
                        <label>Address line 2 <span>*</span></label>
                        <input class="form-control" type="text" name="address2" id="address2" placeholder="{businessaddress2}">
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-lg-6">
                     <div class="form-group">
                        <label>City <span>*</span></label>
                        <input class="form-control" type="text" name="city" id="city" placeholder="{businesscity}">
                     </div>
                  </div>
                  <div class="col-lg-4">
                     <div class="form-group">
                        <label>Post code <span>*</span></label>
                        <input class="form-control" type="number" name="postcode" id="postcode" placeholder="{businesspostcode}">
                     </div>
                  </div>
               </div>
               ...
               <div class="row">
                  <div class="col-lg-6">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="email_notification"  placeholder="{contactnotification}">
                     </div>
                  </div>
               </div>
