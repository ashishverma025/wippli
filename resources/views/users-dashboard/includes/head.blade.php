        ...
        <div class="wrapper">
            ...
            <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: #001f3f;">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            <a href="#" class="dropdown-item">
                                <!-- Message Start -->
                                <div class="media">
                                    <!--<img src="{{ asset('public/student/dist/img/user1-128x128.jpg') }}" alt="User Avatar" class="img-size-50 mr-3 img-circle">-->
                            ...
                            <a href="#" class="dropdown-item">
                                <!-- Message Start -->
                                <div class="media">
                                    <!--<img src="{{ asset('public/student/dist/img/user8-128x128.jpg') }}" alt="User Avatar" class="img-size-50 img-circle mr-3">-->
                                    <div class="media-body">
                                        <h3 class="dropdown-item-title">
                                            John Pierce
                            ...
                            <a href="#" class="dropdown-item">
                                <!-- Message Start -->
                                <div class="media">
                                    <!--<img src="{{ asset('public/student/dist/img/user3-128x128.jpg') }}" alt="User Avatar" class="img-size-50 img-circle mr-3">-->
                                    <div class="media-body">
                                        <h3 class="dropdown-item-title">
                                            Nora Silvester
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" data-toggle="dropdown" href="#">
                            <img src="{{url('public/sites/images')}}/default_profile_user_img.png" class="img-circle elevation-2" height="20" width="20" alt="User Image">

                            <span class="badge badge-warning navbar-badge"></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            <span class="dropdown-item dropdown-header">
                                <img src="{{url('public/sites/images')}}/default_profile_user_img.png" class="img-circle elevation-2" height="25" width="25" alt="User Image">
                            </span>
                            <div class="dropdown-divider"></div>
                            <a href="#" class="dropdown-item">
                                <i class="fas fa-user mr-2 icon-clr"></i> Username({{@$userDetails->name}})
                            </a>
                            <div class="dropdown-divider"></div>
                            <a href="{{asset('editprofile')}}/<?= @$userDetails->id; ?>" class="dropdown-item">
                                <i class="fas fa-users mr-2 icon-clr"></i>My Profile
                            </a>
                            <div class="dropdown-divider"></div>
