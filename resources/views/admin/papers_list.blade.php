                 ...
                 <form id="filter" method="get">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-2">
                                <div class="btn-group">
                                    <a href="{{url('admin/addPapers')}}" id="update_papers_table" class=" btn btn-primary"> Add New</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div>
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" data-page-length='10' id="papers_table" role="grid">
                                <thead>
                                    <tr role="row">
                                        <!--<th class="wid-20" tabindex="0" rowspan="1" colspan="1">Sl</th>-->
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1"> Paper Id</th>
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1"> Paper Name</th>
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1"> Cover Image</th>
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Paper URL</th>
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Paper Description</th>
...
$(document).ready(function () {
    ...
    var url = base_url + "/fetchPapers?{{$_SERVER['QUERY_STRING']}}"

    var table = $('#papers_table');
