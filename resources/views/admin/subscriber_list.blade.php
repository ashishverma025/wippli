        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <!--            <div class="col-md-2">-->
                    <!--                <div class="btn-group">-->
                    <!--                    <a href="{{url('admin/addSubscriber')}}" id="update_StudentData_table" class=" btn btn-primary"> Add New</a>-->
                    <!--                </div>-->
                    <!--            </div>-->
                    <!--        </div>-->
                    <!--    </div>-->
                            ...
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" data-page-length='10' id="StudentData_table" role="grid">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1"> User Email</th> 
                                        ...
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Payment Status</th>
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Transaction Id</th>
...
$(document).ready(function () {
    ...
    var url = base_url + "/fetchSubscriber?{{$_SERVER['QUERY_STRING']}}"
