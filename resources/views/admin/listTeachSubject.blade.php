                ...
                <div class="card-body">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-2">
                                <div class="btn-group">
                                    <a href="{{url('admin/addteachSubject')}}" id="update_attendance_table" class=" btn btn-primary"> Add New</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" data-page-length='10' id="institute_table" role="grid">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Subject Image</th>
...
$(document).ready(function () {
    ...
    var url = base_url + '/fetchteachSubject'
