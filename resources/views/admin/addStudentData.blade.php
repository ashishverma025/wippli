                ...
                <form action="{{asset('admin/addPapers')}}" class="" id="paperForm"  enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <input type="text" class="form-control" id="paper_slug" placeholder="Paper Slug" value="{{@$PaperDetails->paper_slug?@$PaperDetails->paper_slug:''}}"  name="paper_slug">
                        ...
                        <div class="row">
                            ...
                            <select class="form-control" id="answer" name="status">
                                <option value="1" {{@$PaperDetails->status == '1' ? 'selected':''}} >Active</option>
                                <option value="0" {{@$PaperDetails->status == '0' ? 'selected':''}} > Inactive</option>
                            </select>
                        </div>
                         <div class="row">
