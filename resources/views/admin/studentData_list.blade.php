        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <!--            <div class="col-md-2">-->
                    <!--                <div class="btn-group">-->
                    <!--                    <a href="{{url('admin/addStudentData')}}" id="update_StudentData_table" class=" btn btn-primary"> Add New</a>-->
                    <!--                </div>-->
                    <!--            </div>-->
                    <!--        </div>-->
                    <!--    </div>-->
                            ...
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" data-page-length='10' id="StudentData_table" role="grid">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1"> S No</th>
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1"> Student Name</th>
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1"> Stuent Email</th>
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Paper Id</th>
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Total Question</th>
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Total Score</th>
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Student Score</th>
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Right Attempt</th>
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Wrong Attempt</th>
...
$(document).ready(function () {
    ...
    var url = base_url + "/fetchstudentData?{{$_SERVER['QUERY_STRING']}}"
